...
class DataSplitter:
    """
    Performs a chronological data split into train, validation, and test sets.
    """
    ...
    def split_data(self, artifacts_df: pd.DataFrame) -> Dict[str, Dict[str, np.ndarray]]:
        """
        Splits the data into training, validation, and test sets based on chronological cutoff dates.
        """
